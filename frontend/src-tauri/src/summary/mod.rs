...
pub use template_commands::{
    __cmd__api_delete_template, __cmd__api_get_template_content, __cmd__api_get_template_details,
    __cmd__api_list_templates, __cmd__api_save_template, __cmd__api_validate_template,
    __tauri_command_name_api_delete_template, __tauri_command_name_api_get_template_content,
    ...
    api_delete_template, api_get_template_content, api_get_template_details, api_list_templates,
